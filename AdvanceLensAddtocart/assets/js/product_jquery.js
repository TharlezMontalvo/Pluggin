		...
		success : function( response ){
			if(response == 'true'){
				if(product_type == 'Eyeglasses'){
					jQuery("#button_here").html('<button id="show_lenses_popup">Agrégale tus lunas</button>');
					...
					jQuery.ajax({
						...
						success : function( response ){
							var res = JSON.parse(response);
							jQuery("#lens_options_basic_lens").children(".basicLens").children("span").append(" - "+currency_symbol+" "+res.price_data.basic_lenses_additional_price);
								basic_lenses_additional_price = res.price_data.basic_lenses_additional_price;
							jQuery("#lens_options_most_popular_lenses").children(".most_popular_lenses").children("span").append(" - "+currency_symbol+" "+res.price_data.most_popular_lenses_additional_price);
								most_popular_lenses_additional_price = res.price_data.most_popular_lenses_additional_price;
							jQuery("#lens_options_advanced_lens").children(".advanced_lens").children("span").append(" - "+currency_symbol+" "+res.price_data.advanced_lenses_additional_price);
					...
					jQuery.ajax({
						...
						success : function( response ){
							var res = JSON.parse(response);
							jQuery("#sun_lens_basic_colour").children(".sbc").children("span").append(" - "+currency_symbol+" "+res.price_data.basic_tint_additional_price);
								basic_tint_additional_price = res.price_data.basic_tint_additional_price;
							jQuery("#sun_lens_gradient_colour").children(".sgc").children("span").append(" - "+currency_symbol+" "+res.price_data.gradient_tint_lenses_additional_price);
								gradient_tint_lenses_additional_price = res.price_data.gradient_tint_lenses_additional_price;
							jQuery("#sun_lens_mirrored_colour").children(".smc").children("span").append(" - "+currency_symbol+" "+res.price_data.mirrored_tint_additional_price);
					...
					window.setInterval(function(){
						...
						if(current_page == 'design'){
						  jQuery("#ul_content_list").children("#design_li_tracker").addClass("active");
						  ...
						  jQuery("#ul_content_list").children("#material_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#treatment_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#photochromic_tracker").removeClass("active");
						}else if(current_page == 'usage'){
						  jQuery("#ul_content_list").children("#usage_li_tracker").addClass("active");
						  jQuery("#ul_content_list").children("#design_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#prescription_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#material_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#treatment_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#photochromic_tracker").removeClass("active");
						  ...
						  jQuery("#ul_content_list").children("#treatment_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#photochromic_tracker").removeClass("active");
						}else if(current_page == 'material'){
						  jQuery("#ul_content_list").children("#material_li_tracker").addClass("active");
						  jQuery("#ul_content_list").children("#prescription_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#usage_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#design_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#treatment_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#photochromic_tracker").removeClass("active");
						}else if(current_page == 'treatment' || current_page == 'sun_lens_colour_page'){
						  jQuery("#ul_content_list").children("#treatment_tracker").addClass("active");
						  jQuery("#ul_content_list").children("#material_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#prescription_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#usage_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#design_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#photochromic_tracker").removeClass("active");
						}else if(current_page == 'photochromic' || current_page == "blue_lens_blocking_page"){
						  jQuery("#ul_content_list").children("#photochromic_tracker").addClass("active");
						  jQuery("#ul_content_list").children("#treatment_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#material_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#prescription_li_tracker").removeClass("active");
						  jQuery("#ul_content_list").children("#usage_li_tracker").removeClass("active");
					...
					prod_exists="true";
/******************************************************************************************************/
					jQuery("#design_monofocal").click(function(){
						...
						if(design != "Monofocal"){
							...
							jQuery.ajax({
								...
								type : "POST",
								data : {
									action : 'monofocal_prescription_data',
									product_id : product_id,
									design : design,
								},
								success : function(response){
									...
									jQuery("#design_div_box").hide(200);
...
/*******************************************************************************************************/
					...
					jQuery("#confirm_prescription").click(function(){
						...
						if(usage == 'Distance'){
                            ...
                            else if(Number.isNaN(Number(right_eye_sphere_conf)) ||  Number.isNaN(Number(left_eye_sphere_conf)) ||(Number(right_eye_axis_conf) == 0 && jQuery('#right_eye_cylinder').val()!= 'Select Cylinder') || (Number(left_eye_axis_conf) == 0 && jQuery('#left_eye_cylinder').val()!= 'Select Cylinder') ){
...
//								}
                                else if(Number(right_eye_axis_conf) == 0 && jQuery('#right_eye_cylinder').val()!= 'Select Cylinder'){
...
//								}
                                 else if(Number(left_eye_axis_conf) == 0 && jQuery('#left_eye_cylinder').val()!= 'Select Cylinder'){
...
//								}
					...
					jQuery("#lens_type_sun").click(function(){
						...
						jQuery(".container_popup").css("display","none");
                       swal("Success!", "Lenses Added!", "success");
						jQuery("body").removeClass("lens_body");
						add_to_cart = 'enabled';
					});
